...
- Generated media is copied to a profile-scoped permanent library with UTC creation time, prompt, source, SHA-256 identity, and semantic tags.
- Requests for older images search the permanent library by tags, prompt text, and inclusive date range.
