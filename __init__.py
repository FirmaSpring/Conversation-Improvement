...
def _pre_llm_call(session_id: str = "", user_message: str = "", is_first_turn: bool = False, **_: object):
    ...
    common = (
        ...
        "GLOBAL ENFORCEMENT: NEVER call conversation_image_generate as the first image step. Before any image expression or image request, first call conversation_image_search to search actual titles/filenames under C:\\Users\\ChainBox\\AppData\\Local\\hermes\\conversation-improvement\\library\\media (or active $HERMES_HOME equivalent). "
